...
>(({ className, children, ...props }, ref) => (
  <DropdownMenuPrimitive.RadioItem
    ...
    {...props}
  >
    <span className="absolute left-2 h-3.5 w-3.5 rounded-full flex items-center justify-center bg-current">
      <DropdownMenuPrimitive.ItemIndicator>
        <svg className="h-2 w-2 fill-background" viewBox="0 0 8 8">
