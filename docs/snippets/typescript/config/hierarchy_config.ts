import { PdfConfig, HierarchyConfig, ExtractionConfig, extractFileSync } from "kreuzberg";
...
const result = extractFileSync("document.pdf", { config: extractionConfigBasic });
...
const resultMinimal = extractFileSync("document.pdf", { config: extractionConfigMinimal });
...
const resultOcr = extractFileSync("document.pdf", { config: extractionConfigOcr });
